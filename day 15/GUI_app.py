...
ttk.Button(app, text ="Isko bhi",command = lambda:msg.set("hua nahi")).place(x=100,y=170)'''
...
ttk.Label(app, text="parinam").place(x=100,y=300)
ttk.Label(app, textvariable=result, font=('Arial',22)).place(x=100,y=330)

def calci(op):
    print('Main nikal lunga')
...
box=ttk.Listbox(app, height=5, fg='red',bg='black', activestyle='dotbox')
